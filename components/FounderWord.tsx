        ...
        <div className="flex flex-col xl:flex-row justify-between items-center gap-12 lg:gap-20">
          ...
          <div className="relative pl-8 md:pl-16 max-w-3xl">
            ...
            <div ref={contentRef} className="flex flex-col gap-6 md:gap-8">
              ...
              >
                "At Trillex Music Group, we build everything on transparency and
                clear communication. Artists work with a full view of the
                process, from scouting to release. With an artist-first mindset
                and a structured daily workflow, we support each project with
                speed, clarity, and consistency. Our goal is simple: a label
                that earns trust through action and helps artists grow with
                confidence."
              </p>
